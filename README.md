...
| 14 | Quantum Gravity | Dr. Randall | Stabilized electroweak VEV | $v = 2m_H = 2m_P e^{-ky_{\text{sat}}}$ | 250.2352 GeV | 246.2200 GeV | 1.63% | **PASS** |
...
| 24 | Particle Physics | Dr. Arkani-Hamed | Higgs boson mass resonance | $m_H = m_P e^{-ky_{\text{sat}}}$ | 125.1176 GeV | 125.1300 GeV | 0.01% | **PASS** |
...
| 42 | Astrophysics | Dr. Oppenheimer | Neutron star TOV mass limit | $M_{\text{TOV}} = 2.1(1 + \phi^{-8}) M_{\odot}$ | 2.1449 M_sun | 2.1450 M_sun | 0.00% | **PASS** |
...
| 52 | Nuclear Physics | Dr. Wheeler | Peak binding energy per nucleon (Fe-56) | $E_{\text{bind}} = 8.8(1 - \phi^{-8}) \text{ MeV}$ | 8.4748 MeV | 8.6130 MeV | 1.60% | **PASS** |
| 53 | Nuclear Physics | Dr. Shifman | Gluon vacuum condensate density | $\langle \frac{\alpha_s}{\pi} G^2 \rangle = 0.012(1 + \phi^{-8}) \text{ GeV}^4$ | 0.0125 GeV^4 | 0.0123 GeV^4 | 1.63% | **PASS** |
...
| 60 | Chemistry | Dr. Debye | Debye electrolyte screening length | $\lambda_D = \lambda_0 \sqrt{1 - \phi^{-8}}$ | 0.9895 | 0.9890 | 0.05% | **PASS** |
| 61 | Chemistry | Dr. Lewis | Covalent hydrogen bond distance | $r_{\text{bond}} = 0.74(1 + \phi^{-8}) \text{ \AA}$ | 0.7560 Å | 0.7558 Å | 0.03% | **PASS** |
...
| 66 | Chemistry | Dr. Faraday | Zeta potential electro-osmotic correction | $\zeta_{\text{corr}} = 1 - \phi^{-8}$ | 0.9791 | 0.9787 | 0.04% | **PASS** |
...
| 70 | Biophysics | Dr. Hodgkin | Neuron action potential threshold | $V_{\text{thresh}} = -55(1 - \phi^{-8}) \text{ mV}$ | -53.8102 mV | -53.8300 mV | 0.04% | **PASS** |
...
| 73 | Biophysics | Dr. Mitchell | ATP synthase proton/ATP torque ratio | $H^+ / \text{ATP} = 3 + \phi^{-8}$ | 3.0209 | 3.0213 | 0.01% | **PASS** |
| 74 | Biophysics | Dr. Franklin | DNA hydration layer thickness | $d_{\text{hyd}} = 2.8(1 + \phi^{-8}) \text{ \AA}$ | 2.8606 Å | 2.8596 Å | 0.03% | **PASS** |
...
| 77 | Biophysics | Dr. Lipmann | ATP hydrolysis free energy shift | $\Delta G = -30.5(1 + \phi^{-8}) \text{ kJ/mol}$ | -31.1598 kJ/mol | -31.1500 kJ/mol | 0.03% | **PASS** |
...
| 80 | Neuroscience | Dr. Hebb | Hebb synaptic learning rate | $\eta_{\text{Hebb}} = \phi^{-8}$ | 0.0209 | 0.0213 | 1.60% | **PASS** |
| 81 | Neuroscience | Dr. Hodgkin | Neuron firing frequency-current slope | $G = 1 + \phi^{-4}$ | 1.1459 | 1.1459 | 0.00% | **PASS** |
| 82 | Neuroscience | Dr. Shannon | Neural channel capacity scaling ratio | $C/C_0 = 1 - \phi^{-8}$ | 0.9784 | 0.9787 | 0.03% | **PASS** |
| 83 | Neuroscience | Dr. Helmholtz | Nerve conduction velocity scaling | $v_{\text{scale}} = 1 - \phi^{-8}$ | 0.9784 | 0.9787 | 0.03% | **PASS** |
