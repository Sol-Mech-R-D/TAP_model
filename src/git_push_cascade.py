...
PUBLIC_FILES = [
    ...
    "docs/TAP_Global_Weather_Operations.md",
    ...
    # Assets / Public Data
    "assets/tap_global_weather_results.json",
    ...
    "src/tap_qubit_coherence_sweep.py",
    "src/run_tetrahedral_sweep.py",
    ...
    "assets/tap_qubit_coherence_sweep.png",
    "assets/tap_tetrahedral_sweep_results.png",
    ...
    "docs/TAP_Qubit_Coherence_Sweep_Results.md",
    ...
    "src/run_coupled_sweep.py",
    "docs/TAP_Coupled_Waveguide_Sweep_Results.md",
    "assets/tap_coupled_waveguide_sweep.png",
    ...
    "assets/tap_coupled_2d_heatmap.png",
    "TERMUX_NOTE.md",
