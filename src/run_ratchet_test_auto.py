...
to show the temporal asymmetry (one-way charge flow) fully automatically.
"""
...
def main():
    print("=" * 80)
    print("  TAP DIODE-CAPACITOR RATCHET TEST CLIENT (FULLY AUTOMATED)")
